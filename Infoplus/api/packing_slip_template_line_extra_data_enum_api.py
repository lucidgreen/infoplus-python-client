...
class PackingSlipTemplateLineExtraDataEnumApi(object):
    ...
    def get_packing_slip_template_line_extra_data_enum_by_id(self, packing_slip_template_line_extra_data_enum_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_packing_slip_template_line_extra_data_enum_by_id(packing_slip_template_line_extra_data_enum_id, is_async=True)
        >>> result = thread.get()
    ...
    def get_packing_slip_template_line_extra_data_enum_by_id_with_http_info(self, packing_slip_template_line_extra_data_enum_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass is_async=True
        >>> thread = api.get_packing_slip_template_line_extra_data_enum_by_id_with_http_info(packing_slip_template_line_extra_data_enum_id, is_async=True)
        >>> result = thread.get()
    ...
    def get_packing_slip_template_line_extra_data_enum_by_search_text(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass is_async=True
        >>> thread = api.get_packing_slip_template_line_extra_data_enum_by_search_text(is_async=True)
        >>> result = thread.get()
    ...
    def get_packing_slip_template_line_extra_data_enum_by_search_text_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass is_async=True
        >>> thread = api.get_packing_slip_template_line_extra_data_enum_by_search_text_with_http_info(is_async=True)
        >>> result = thread.get()
